...
//  Sustain
//
//  Created by Jocelyn Zhao on 2022-02-02.
//

import Foundation
import SwiftUI

//Controls the expanding circle transition from the LoginView into the MainView
struct ScaledCircle: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        let maximumCircleRadius = sqrt(rect.width * rect.width + rect.height * rect.height * 1.5)
